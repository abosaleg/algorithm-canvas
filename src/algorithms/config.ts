...
export const algorithms: AlgorithmDefinition[] = [
  ...
  },
  {
    ...
    name: '0/1 Knapsack',
    category: 'dynamic-programming',
    route: '/algorithms/dynamic-programming/knapsack-01',
    description: 'Find maximum value in a knapsack with capacity constraint.',
    longDescription: 'The 0/1 Knapsack problem uses dynamic programming to find the maximum value of items that can fit in a knapsack with limited capacity, where each item can only be taken once (0 or 1).',
    tags: ['optimization', 'tabulation', 'decision'],
    complexity: {
      time: { average: 'O(n × W)', worst: 'O(n × W)' },
      space: 'O(n × W)',
    },
    supportedLanguages: ['javascript', 'python', 'pseudocode'],
    useCases: ['Resource allocation', 'Investment decisions', 'Cargo loading'],
  },
  {
    id: 'lcs',
    name: 'Longest Common Subsequence',
    category: 'dynamic-programming',
    route: '/algorithms/dynamic-programming/lcs',
    description: 'Find the longest subsequence common to two sequences.',
    longDescription: 'LCS finds the longest subsequence present in both given sequences in the same relative order. Uses dynamic programming with backtracking to reconstruct the actual subsequence.',
    tags: ['string', 'tabulation', 'backtracking'],
    complexity: {
      time: { average: 'O(m × n)', worst: 'O(m × n)' },
      space: 'O(m × n)',
    },
    supportedLanguages: ['javascript', 'python', 'pseudocode'],
  ...
  },
  {
    ...
    name: 'Bellman-Ford',
    category: 'dynamic-programming',
    route: '/algorithms/dynamic-programming/bellman-ford',
    description: 'Find shortest paths from source to all vertices, handles negative weights.',
    longDescription: 'Bellman-Ford algorithm computes shortest paths from a single source vertex to all other vertices. Unlike Dijkstra, it can handle graphs with negative edge weights and detect negative cycles.',
    tags: ['graph', 'shortest-path', 'relaxation'],
    complexity: {
      time: { average: 'O(V × E)', worst: 'O(V × E)' },
      space: 'O(V)',
    },
    supportedLanguages: ['javascript', 'python', 'pseudocode'],
    useCases: ['Network routing', 'Arbitrage detection', 'Distance-vector routing'],
  },
  {
    id: 'tower-of-hanoi',
    name: 'Tower of Hanoi',
